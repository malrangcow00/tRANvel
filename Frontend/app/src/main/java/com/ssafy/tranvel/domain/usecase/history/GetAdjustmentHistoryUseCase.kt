...
class GetAdjustmentHistoryUseCase @Inject constructor(
    private val historyRepository : HistoryRepository
){
    suspend fun execute(roomId : Long) :Flow<DataState<AdjustmentHistoryResponse>> {
        return historyRepository.getAdjustmentHistory(roomId)
    }
}
